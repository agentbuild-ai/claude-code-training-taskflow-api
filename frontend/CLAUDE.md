...
**Why this stack:** standalone components avoid `NgModule` boilerplate for an app this small. Signals instead of NgRx because there's no need for action/reducer ceremony at this scale — a writable signal per service is enough state management. Tailwind utility classes directly in templates instead of component CSS files, for speed of iteration in a demo app.
